...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "eggs_core.log_space_home_detail": "  ✗ /home (área de trabalho do build): {free:.1f} GB livres — necessário ~{needed:.1f} GB (o penguins-eggs monta a live inteira ali antes de empacotar)",
        "eggs_core.status_space_home_fail": "Espaço insuficiente em /home para montar o build — libere espaço antes de tentar de novo.",
        ...
        "eggs_core.status_op_done": "Concluído com sucesso.",
        "eggs.moving_title": "Movendo {name}...",
        "eggs.copying_title": "Copiando {name}...",
        "eggs_core.log_cleaning": "Limpando: {dir}",
        "eggs_core.log_precleanup_header": "Limpando cache de pacotes e vestígios de builds anteriores antes de checar espaço...",
        "eggs_core.log_precleanup_skipped_busy": "  pacman/paru/yay em uso agora — pulando limpeza de cache pra não corromper build/instalação em andamento.",
        "eggs_core.log_precleanup_pacman": "  Cache do pacman: {freed:.1f} GB liberados",
        "eggs_core.log_precleanup_home": "  Cache do yay/paru + vestígios do Eggs: {freed:.1f} GB liberados em /home",
        ...
        "backup.waiting_to_start": "Aguardando início...",
        "backup.current_file_label": "Arquivo atual: {text}",
        "backup.btn_cancel": "Cancelar",
        "backup.btn_cancel_confirm": "Cancelar ({s}s)",
        "backup.btn_cancel_confirm_hint": "Cancelar ({s}s) — clique p/ confirmar",
        "backup.btn_cancelling": "Cancelando...",
        "backup.btn_close": "Fechar",
        "snapshots.alt_dest_panel_title": "Espaço insuficiente no destino escolhido (necessário ~{gb} GB). Escolha outro disco:",
        "snapshots.alt_dest_recommended": "RECOMENDADO",
        "snapshots.alt_dest_cancelled_by_close": "Cancelado pelo usuário fechando a janela.",
        "snapshots.check_space_ok": "Espaço OK em {dest}: {free:.1f} GB livres (estimativa: {needed:.1f} GB).",
        "snapshots.check_space_insufficient": "Espaço insuficiente em {dest}: {free:.1f} GB livres, precisa de ~{needed:.1f} GB.",
        "snapshots.check_space_no_alt": "Nenhum disco alternativo com espaço suficiente encontrado.",
        "snapshots.check_space_suggesting": "Sugerindo {count} disco(s) alternativo(s)...",
        "snapshots.check_space_no_alt_chosen": "Nenhuma alternativa escolhida.",
        "snapshots.check_space_new_dest_chosen": "Novo destino escolhido: {chosen}",
        ...
        "helper.unexpected_error": "Erro inesperado",
        "helper.unexpected_error_status": "Falha inesperada.",
        ...
        "menu.configuracoes_placeholder_msg": "Tela de configurações (export/import, preferências gerais) ainda não foi implementada.",
        ...
        "clonezilla.action_explore": "Explorar",
        "clonezilla.section_raw_title": "IMAGENS GERADAS PELO CLONEZILLA",
        "clonezilla.raw_already_compressed": "já comprimida",
        "clonezilla.raw_count_singular": "1 pasta",
        "clonezilla.raw_count_plural": "{n} pastas",
        "clonezilla.raw_occupied_suffix": "recuperáveis",
        "clonezilla.raw_hint": "Cópia original do Clonezilla, mantida no disco mesmo após a compressão.",
        "clonezilla.explore_not_found": "Nautilus não encontrado — verifique se o pacote nautilus está instalado.",
        ...
        "snapshots.create_badge_title": "Criação automática",
        "snapshots.create_badge_disabled": "desativada",
        "snapshots.create_badge_next": "próxima {when}",
        "snapshots.create_dialog_title": "Criação Automática de Snapshot",
        "snapshots.create_auto_dialog_title": "Criando snapshot automático ({kind})",
        "snapshots.sync_auto_dialog_title": "Sincronizando automaticamente ({kind})",
        "snapshots.create_retention_label": "RETENÇÃO",
        "snapshots.create_retention_hint": "Quantos snapshots manter de cada tipo, por destino — os mais antigos além disso são apagados automaticamente a cada execução.",
        "snapshots.create_retention_unlimited": "Sem limite",
        "snapshots.create_min_free_label": "ESPAÇO MÍNIMO LIVRE",
        "snapshots.create_min_free_hint": "Se o destino tiver menos que isso livre, a criação é pulada nessa rodada (a retenção ainda roda, pode liberar espaço pra próxima vez). 0 desativa a checagem.",
        "snapshots.create_space_failed_status": "Espaço insuficiente para criar o snapshot — veja o log.",
        ...
        "snapshots.create_result_success": "sucesso",
        ...
        "snapshots.create_toast_success": "Snapshot criado automaticamente — {kinds}",
        "snapshots.create_toast_failed": "Criação automática de snapshot falhou — veja o agendamento pra detalhes",
        ...
        "eggs.btn_move": "Mover para outro disco",
        "eggs.move_dialog_title": "Escolha o disco de destino para mover:",
        "eggs.move_no_disks": "Nenhum outro disco disponível encontrado.",
        "eggs.move_failed": "Falha ao mover: {err}",
        "eggs.btn_more_options": "Mais opções",
        "eggs.btn_copy": "Copiar para outro disco",
        "eggs.copy_dialog_title": "Escolha o disco de destino para copiar:",
        "eggs.copy_failed": "Falha ao copiar: {err}",
        "eggs.btn_confirm_destination": "Confirmar",
        "eggs.choose_disk_header": "Escolher disco de destino",
    ...
    "en": {
        ...
        "eggs_core.log_space_home_detail": "  ✗ /home (build workspace): {free:.1f} GB free — needs ~{needed:.1f} GB (penguins-eggs assembles the whole live tree there before packaging)",
        "eggs_core.status_space_home_fail": "Not enough space in /home to assemble the build — free up space and try again.",
        ...
        "eggs_core.status_op_done": "Completed successfully.",
        "eggs.moving_title": "Moving {name}...",
        "eggs.copying_title": "Copying {name}...",
        "eggs_core.log_cleaning": "Cleaning: {dir}",
        "eggs_core.log_precleanup_header": "Cleaning package cache and leftovers from previous builds before checking space...",
        "eggs_core.log_precleanup_skipped_busy": "  pacman/paru/yay currently in use — skipping cache cleanup to avoid corrupting an ongoing build/install.",
        "eggs_core.log_precleanup_pacman": "  Pacman cache: {freed:.1f} GB freed",
        "eggs_core.log_precleanup_home": "  yay/paru cache + Eggs leftovers: {freed:.1f} GB freed in /home",
        ...
        "backup.waiting_to_start": "Waiting to start...",
        "backup.current_file_label": "Current file: {text}",
        "backup.btn_cancel": "Cancel",
        "backup.btn_cancel_confirm": "Cancel ({s}s)",
        "backup.btn_cancel_confirm_hint": "Cancel ({s}s) — click to confirm",
        "backup.btn_cancelling": "Cancelling...",
        "backup.btn_close": "Close",
        "snapshots.alt_dest_panel_title": "Not enough space on the chosen destination (needs ~{gb} GB). Pick another disk:",
        "snapshots.alt_dest_recommended": "RECOMMENDED",
        "snapshots.alt_dest_cancelled_by_close": "Cancelled by the user closing the window.",
        "snapshots.check_space_ok": "Space OK on {dest}: {free:.1f} GB free (estimate: {needed:.1f} GB).",
        "snapshots.check_space_insufficient": "Not enough space on {dest}: {free:.1f} GB free, needs ~{needed:.1f} GB.",
        "snapshots.check_space_no_alt": "No alternative disk with enough space found.",
        "snapshots.check_space_suggesting": "Suggesting {count} alternative disk(s)...",
        "snapshots.check_space_no_alt_chosen": "No alternative chosen.",
        "snapshots.check_space_new_dest_chosen": "New destination chosen: {chosen}",
        ...
        "helper.unexpected_error": "Unexpected error",
        "helper.unexpected_error_status": "Unexpected failure.",
        ...
        "menu.configuracoes_placeholder_msg": "Settings screen (export/import, general preferences) hasn't been implemented yet.",
        "menu.back_to_menu": "Back to menu: button or Esc",
        "common.close": "Close",
        ...
        "clonezilla.action_explore": "Explore",
        "clonezilla.section_raw_title": "IMAGES GENERATED BY CLONEZILLA",
        "clonezilla.raw_already_compressed": "already compressed",
        "clonezilla.raw_count_singular": "1 folder",
        "clonezilla.raw_count_plural": "{n} folders",
        "clonezilla.raw_occupied_suffix": "recoverable",
        "clonezilla.raw_hint": "Original Clonezilla copy, kept on disk even after compression.",
        "clonezilla.explore_not_found": "Nautilus not found — check that the nautilus package is installed.",
        ...
        "snapshots.create_badge_title": "Auto create",
        "snapshots.create_badge_disabled": "disabled",
        "snapshots.create_badge_next": "next {when}",
        "snapshots.create_dialog_title": "Automatic Snapshot Creation",
        "snapshots.create_auto_dialog_title": "Creating automatic snapshot ({kind})",
        "snapshots.sync_auto_dialog_title": "Automatically syncing ({kind})",
        "snapshots.create_retention_label": "RETENTION",
        "snapshots.create_retention_hint": "How many snapshots to keep of each type, per destination — older ones beyond that are deleted automatically on every run.",
        "snapshots.create_retention_unlimited": "Unlimited",
        "snapshots.create_min_free_label": "MINIMUM FREE SPACE",
        "snapshots.create_min_free_hint": "If the destination has less than this free, creation is skipped this run (retention still runs, which may free up space for next time). 0 disables the check.",
        "snapshots.create_space_failed_status": "Not enough space to create the snapshot — see the log.",
        ...
        "snapshots.create_result_success": "success",
        ...
        "snapshots.create_toast_success": "Snapshot created automatically — {kinds}",
        "snapshots.create_toast_failed": "Automatic snapshot creation failed — check the schedule for details",
        ...
        "eggs.btn_move": "Move to another disk",
        "eggs.move_dialog_title": "Choose the destination disk to move to:",
        "eggs.move_no_disks": "No other disk available was found.",
        "eggs.move_failed": "Failed to move: {err}",
        "eggs.btn_more_options": "More options",
        "eggs.btn_copy": "Copy to another disk",
        "eggs.copy_dialog_title": "Choose the destination disk to copy to:",
        "eggs.copy_failed": "Failed to copy: {err}",
        "eggs.btn_confirm_destination": "Confirm",
        "eggs.choose_disk_header": "Choose destination disk",
    ...
    "es": {
        ...
        "eggs_core.log_space_home_detail": "  ✗ /home (área de trabajo del build): {free:.1f} GB libres — se necesitan ~{needed:.1f} GB (penguins-eggs monta toda la live ahí antes de empaquetar)",
        "eggs_core.status_space_home_fail": "Espacio insuficiente en /home para montar el build — libere espacio e intente de nuevo.",
        ...
        "eggs_core.status_op_done": "Completado con éxito.",
        "eggs.moving_title": "Moviendo {name}...",
        "eggs.copying_title": "Copiando {name}...",
        "eggs_core.log_cleaning": "Limpiando: {dir}",
        "eggs_core.log_precleanup_header": "Limpiando caché de paquetes y restos de builds anteriores antes de revisar el espacio...",
        "eggs_core.log_precleanup_skipped_busy": "  pacman/paru/yay en uso ahora — omitiendo limpieza de caché para no corromper un build/instalación en curso.",
        "eggs_core.log_precleanup_pacman": "  Caché de pacman: {freed:.1f} GB liberados",
        "eggs_core.log_precleanup_home": "  Caché de yay/paru + restos de Eggs: {freed:.1f} GB liberados en /home",
        ...
        "backup.waiting_to_start": "Esperando para empezar...",
        "backup.current_file_label": "Archivo actual: {text}",
        "backup.btn_cancel": "Cancelar",
        "backup.btn_cancel_confirm": "Cancelar ({s}s)",
        "backup.btn_cancel_confirm_hint": "Cancelar ({s}s) — clic para confirmar",
        "backup.btn_cancelling": "Cancelando...",
        "backup.btn_close": "Cerrar",
        "snapshots.alt_dest_panel_title": "Espacio insuficiente en el destino elegido (necesario ~{gb} GB). Elija otro disco:",
        "snapshots.alt_dest_recommended": "RECOMENDADO",
        "snapshots.alt_dest_cancelled_by_close": "Cancelado por el usuario al cerrar la ventana.",
        "snapshots.check_space_ok": "Espacio OK en {dest}: {free:.1f} GB libres (estimado: {needed:.1f} GB).",
        "snapshots.check_space_insufficient": "Espacio insuficiente en {dest}: {free:.1f} GB libres, se necesitan ~{needed:.1f} GB.",
        "snapshots.check_space_no_alt": "No se encontró ningún disco alternativo con espacio suficiente.",
        "snapshots.check_space_suggesting": "Sugiriendo {count} disco(s) alternativo(s)...",
        "snapshots.check_space_no_alt_chosen": "No se eligió ninguna alternativa.",
        "snapshots.check_space_new_dest_chosen": "Nuevo destino elegido: {chosen}",
        ...
        "helper.invalid_json_args": "Argumentos JSON inválidos: {exc}",
        "helper.unexpected_error": "Error inesperado",
        "helper.unexpected_error_status": "Falla inesperada.",
        ...
        "menu.configuracoes_placeholder_msg": "La pantalla de configuración (exportar/importar, preferencias generales) todavía no está implementada.",
        "menu.back_to_menu": "Back to menu: button or Esc",
        "common.close": "Cerrar",
        "common.cancel": "Cancelar",
        "common.confirm": "Confirmar",
        ...
        "clonezilla.action_explore": "Explorar",
        "clonezilla.section_raw_title": "IMÁGENES GENERADAS POR CLONEZILLA",
        "clonezilla.raw_already_compressed": "ya comprimida",
        "clonezilla.raw_count_singular": "1 carpeta",
        "clonezilla.raw_count_plural": "{n} carpetas",
        "clonezilla.raw_occupied_suffix": "recuperables",
        "clonezilla.raw_hint": "Copia original de Clonezilla, conservada en disco incluso tras comprimir.",
        "clonezilla.explore_not_found": "No se encontró Nautilus — verifique que el paquete nautilus esté instalado.",
        ...
        "snapshots.create_badge_title": "Creación automática",
        "snapshots.create_badge_disabled": "desactivada",
        "snapshots.create_badge_next": "próxima {when}",
        "snapshots.create_dialog_title": "Creación Automática de Snapshot",
        "snapshots.create_auto_dialog_title": "Creando snapshot automático ({kind})",
        "snapshots.sync_auto_dialog_title": "Sincronizando automáticamente ({kind})",
        "snapshots.create_retention_label": "RETENCIÓN",
        "snapshots.create_retention_hint": "Cuántos snapshots mantener de cada tipo, por destino — los más antiguos además de eso se eliminan automáticamente en cada ejecución.",
        "snapshots.create_retention_unlimited": "Sin límite",
        "snapshots.create_min_free_label": "ESPACIO MÍNIMO LIBRE",
        "snapshots.create_min_free_hint": "Si el destino tiene menos que esto libre, la creación se omite en esta ejecución (la retención igual se aplica, lo que puede liberar espacio para la próxima vez). 0 desactiva la comprobación.",
        "snapshots.create_space_failed_status": "Espacio insuficiente para crear el snapshot — vea el registro.",
        ...
        "snapshots.create_result_success": "éxito",
        ...
        "snapshots.create_toast_success": "Snapshot creado automáticamente — {kinds}",
        "snapshots.create_toast_failed": "La creación automática de snapshot falló — vea la programación para más detalles",
        ...
        "eggs.btn_move": "Mover a otro disco",
        "eggs.move_dialog_title": "Elija el disco de destino para mover:",
        "eggs.move_no_disks": "No se encontró ningún otro disco disponible.",
        "eggs.move_failed": "Error al mover: {err}",
        "eggs.btn_more_options": "Más opciones",
        "eggs.btn_copy": "Copiar a otro disco",
        "eggs.copy_dialog_title": "Elija el disco de destino para copiar:",
        "eggs.copy_failed": "Error al copiar: {err}",
        "eggs.btn_confirm_destination": "Confirmar",
        "eggs.choose_disk_header": "Elegir disco de destino",
