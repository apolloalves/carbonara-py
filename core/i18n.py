...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "menu.sobre": "Sobre",
        "menu.inicio_button": "Início",
        "backup.copying_prefix": "Copiando",
        "backup.starting_kind": "Iniciando {kind}...",
        "backup.copying_kind": "Copiando {kind}...",
        "backup.syncing_kind": "Sincronizando {kind}...",
        "backup.preparing": "Preparando backup...",
        "backup.done_ok": "Backup concluído com sucesso.",
        "backup.header_backup": "=== BACKUP {kind} [{stamp}] ===",
        "backup.footer_kind_done": "--- {kind} finalizado com sucesso ---",
        "backup.log_error_prefix": "ERRO: {msg}",
        "backup.kind_failed": "Falha no backup {kind}",
        "backup.header_sync": "=== SYNC {kind} [{stamp}] ===",
        "backup.footer_sync_done": "--- SYNC {kind} concluído ---",
        "backup.sync_done_ok": "Sincronização concluída com sucesso.",
        "backup.sync_kind_failed": "Falha na sincronização {kind}",
        "restore.restoring_home": "Restaurando HOME...",
        "restore.home_done_footer": "--- RESTORE HOME concluído ---",
        "restore.home_done_status": "HOME restaurada com sucesso.",
        "restore.home_fail_status": "Falha ao restaurar HOME",
        "restore.home_done_message": "{name} foi restaurado em /home.",
        "backup.elapsed_time": "Tempo decorrido: {elapsed}",
        "backup.cancel_ignored": "Cancelamento ignorado. Backup continua...",
        "backup.interrupting": "Interrompendo backup...",
        "backup.cancelled_footer": "— Backup cancelado. Snapshot incompleto removido. —",
        "backup.cancelled_status": "Cancelado pelo usuário.",
        "backup.running_status": "Backup em execução. Use Cancelar para interromper.",
        "backup.cleanup_timeout_footer": "— Limpeza demorou mais que o esperado, encerrando mesmo assim. —",
        "backup.pair_check_title": "Verificando snapshot irmão",
        "backup.pair_check_header": "Verificando Snapshot Irmão",
        "backup.pair_check_status": "Verificando alterações pendentes",
        "snapshots.verifying_op_label": "Verificando {label}",
        "snapshots.op_already_running_generic": "Outra operação já está em andamento.",
        "common.tooltip_minimize": "Minimizar",
        "common.tooltip_maximize": "Maximizar",
        "common.tooltip_restore": "Restaurar",
        "common.waiting_start": "Aguardando início...",
        "common.cancel_button": "Cancelar",
        "common.cancel_button_countdown": "Cancelar ({s}s)",
        "common.cancel_button_confirm": "Cancelar ({s}s) — clique p/ confirmar",
        "common.cancelling": "Cancelando...",
        "common.elapsed_time_label": "Tempo decorrido",
        "common.remaining_time_label": "Tempo estimado restante",
        "common.overall_progress_label": "Progresso geral",
        "common.current_operation_label": "Operação atual",
        "common.transferring_label": "Transferindo:",
        "common.cancel_ignored_op": "Cancelamento ignorado. Operação continua...",
        "common.cancelled_short": "Cancelado.",
        "common.starting": "Iniciando...",
        "backup.dialog_title_create": "Create Snapshot",
        "backup.dialog_title_sync": "Sincronizando Snapshot",
        "backup.dialog_title_restore": "Restore para {dest}",
        "backup.dialog_title_restore_home": "Restaurando HOME",
        "backup.starting_restore": "Iniciando restore...",
        "backup.copying_snapshot": "Copiando snapshot...",
        "backup.restore_done_ok": "Restore concluído com sucesso.",
        "backup.error_prefix": "Erro: {msg}",
        "helper.file_not_found": "Arquivo não encontrado: {path}",
        "helper.dirs_created": "Diretórios criados: {created}",
        "helper.none_placeholder": "nenhum",
        "helper.skipping_no_tool": "Pulando {dev}: ferramenta '{tool}' não instalada",
        "helper.no_eligible_volume": "Nenhum volume elegível encontrado (tudo montado ou sem checador).",
        "helper.no_owner_pkg_found": "Nenhum pacote encontrado como dono desses arquivos — não dá pra reinstalar automaticamente.",
        "helper.reinstall_done": "Reinstalação concluída: {pkgs}",
        "helper.pacman_exit_code": "pacman saiu com código {code} — revise a saída acima.",
        "helper.invalid_json_args": "Argumentos JSON inválidos: {exc}",
        "helper.unknown_action": "Ação desconhecida: {action}",
        "clonezilla.interrupting_compression": "Interrompendo compressão...",
        "clonezilla.cancelled_footer": "— Compressão cancelada. —",
        "eggs.cancelling_op": "Cancelando operação...",
        "eggs.cancelled_by_user": "Operação cancelada pelo usuário.",
        "eggs.cancelled_footer": "--- Operação cancelada. Diretório /home/eggs removido. ---",
        "eggs.done_title": "Concluído",
        "eggs.done_success_label": "Concluído com sucesso",
    ...
    "en": {
        ...
        "menu.sobre": "About",
        "menu.inicio_button": "Home",
        "backup.copying_prefix": "Copying",
        "backup.starting_kind": "Starting {kind}...",
        "backup.copying_kind": "Copying {kind}...",
        "backup.syncing_kind": "Syncing {kind}...",
        "backup.preparing": "Preparing backup...",
        "backup.done_ok": "Backup completed successfully.",
        "backup.header_backup": "=== BACKUP {kind} [{stamp}] ===",
        "backup.footer_kind_done": "--- {kind} finished successfully ---",
        "backup.log_error_prefix": "ERROR: {msg}",
        "backup.kind_failed": "{kind} backup failed",
        "backup.header_sync": "=== SYNC {kind} [{stamp}] ===",
        "backup.footer_sync_done": "--- SYNC {kind} complete ---",
        "backup.sync_done_ok": "Sync completed successfully.",
        "backup.sync_kind_failed": "{kind} sync failed",
        "restore.restoring_home": "Restoring HOME...",
        "restore.home_done_footer": "--- RESTORE HOME complete ---",
        "restore.home_done_status": "HOME restored successfully.",
        "restore.home_fail_status": "Failed to restore HOME",
        "restore.home_done_message": "{name} was restored to /home.",
        "backup.elapsed_time": "Elapsed time: {elapsed}",
        "backup.cancel_ignored": "Cancel ignored. Backup continues...",
        "backup.interrupting": "Interrupting backup...",
        "backup.cancelled_footer": "— Backup cancelled. Incomplete snapshot removed. —",
        "backup.cancelled_status": "Cancelled by user.",
        "backup.running_status": "Backup running. Use Cancel to interrupt.",
        "backup.cleanup_timeout_footer": "— Cleanup took longer than expected, closing anyway. —",
        "backup.pair_check_title": "Checking sibling snapshot",
        "backup.pair_check_header": "Checking Sibling Snapshot",
        "backup.pair_check_status": "Checking for pending changes",
        "snapshots.verifying_op_label": "Verifying {label}",
        "snapshots.op_already_running_generic": "Another operation is already running.",
        "common.tooltip_minimize": "Minimize",
        "common.tooltip_maximize": "Maximize",
        "common.tooltip_restore": "Restore",
        "common.waiting_start": "Waiting to start...",
        "common.cancel_button": "Cancel",
        "common.cancel_button_countdown": "Cancel ({s}s)",
        "common.cancel_button_confirm": "Cancel ({s}s) — click to confirm",
        "common.cancelling": "Cancelling...",
        "common.elapsed_time_label": "Elapsed time",
        "common.remaining_time_label": "Estimated time remaining",
        "common.overall_progress_label": "Overall progress",
        "common.current_operation_label": "Current operation",
        "common.transferring_label": "Transferring:",
        "common.cancel_ignored_op": "Cancel ignored. Operation continues...",
        "common.cancelled_short": "Cancelled.",
        "common.starting": "Starting...",
        "backup.dialog_title_create": "Create Snapshot",
        "backup.dialog_title_sync": "Syncing Snapshot",
        "backup.dialog_title_restore": "Restore to {dest}",
        "backup.dialog_title_restore_home": "Restoring HOME",
        "backup.starting_restore": "Starting restore...",
        "backup.copying_snapshot": "Copying snapshot...",
        "backup.restore_done_ok": "Restore completed successfully.",
        "backup.error_prefix": "Error: {msg}",
        "helper.file_not_found": "File not found: {path}",
        "helper.dirs_created": "Directories created: {created}",
        "helper.none_placeholder": "none",
        "helper.skipping_no_tool": "Skipping {dev}: tool '{tool}' not installed",
        "helper.no_eligible_volume": "No eligible volume found (all mounted or no checker available).",
        "helper.no_owner_pkg_found": "No package found owning these files — can't reinstall automatically.",
        "helper.reinstall_done": "Reinstall complete: {pkgs}",
        "helper.pacman_exit_code": "pacman exited with code {code} — review the output above.",
        "helper.invalid_json_args": "Invalid JSON arguments: {exc}",
        "helper.unknown_action": "Unknown action: {action}",
        "clonezilla.interrupting_compression": "Interrupting compression...",
        "clonezilla.cancelled_footer": "— Compression cancelled. —",
        "eggs.cancelling_op": "Cancelling operation...",
        "eggs.cancelled_by_user": "Operation cancelled by user.",
        "eggs.cancelled_footer": "--- Operation cancelled. /home/eggs directory removed. ---",
        "eggs.done_title": "Done",
        "eggs.done_success_label": "Completed successfully",
    ...
    "es": {
        ...
        "menu.inicio_button": "Inicio",
        "backup.copying_prefix": "Copiando",
        "backup.starting_kind": "Iniciando {kind}...",
        "backup.copying_kind": "Copiando {kind}...",
        "backup.syncing_kind": "Sincronizando {kind}...",
        "backup.preparing": "Preparando copia de seguridad...",
        "backup.done_ok": "Copia de seguridad completada correctamente.",
        "backup.header_backup": "=== BACKUP {kind} [{stamp}] ===",
        "backup.footer_kind_done": "--- {kind} finalizado correctamente ---",
        "backup.log_error_prefix": "ERROR: {msg}",
        "backup.kind_failed": "Falló la copia de seguridad de {kind}",
        "backup.header_sync": "=== SYNC {kind} [{stamp}] ===",
        "backup.footer_sync_done": "--- SYNC {kind} completado ---",
        "backup.sync_done_ok": "Sincronización completada correctamente.",
        "backup.sync_kind_failed": "Falló la sincronización de {kind}",
        "restore.restoring_home": "Restaurando HOME...",
        "restore.home_done_footer": "--- RESTORE HOME completado ---",
        "restore.home_done_status": "HOME restaurado correctamente.",
        "restore.home_fail_status": "Error al restaurar HOME",
        "restore.home_done_message": "{name} fue restaurado en /home.",
        "backup.elapsed_time": "Tiempo transcurrido: {elapsed}",
        "backup.cancel_ignored": "Cancelación ignorada. La copia de seguridad continúa...",
        "backup.interrupting": "Interrumpiendo copia de seguridad...",
        "backup.cancelled_footer": "— Copia de seguridad cancelada. Snapshot incompleto eliminado. —",
        "backup.cancelled_status": "Cancelado por el usuario.",
        "backup.running_status": "Copia de seguridad en curso. Use Cancelar para interrumpir.",
        "backup.cleanup_timeout_footer": "— La limpieza tardó más de lo esperado, cerrando de todos modos. —",
        "backup.pair_check_title": "Verificando snapshot hermano",
        "backup.pair_check_header": "Verificando Snapshot Hermano",
        "backup.pair_check_status": "Verificando cambios pendientes",
        "snapshots.verifying_op_label": "Verificando {label}",
        "snapshots.op_already_running_generic": "Ya hay otra operación en curso.",
        "common.tooltip_minimize": "Minimizar",
        "common.tooltip_maximize": "Maximizar",
        "common.tooltip_restore": "Restaurar",
        "common.waiting_start": "Esperando inicio...",
        "common.cancel_button": "Cancelar",
        "common.cancel_button_countdown": "Cancelar ({s}s)",
        "common.cancel_button_confirm": "Cancelar ({s}s) — clic para confirmar",
        "common.cancelling": "Cancelando...",
        "common.elapsed_time_label": "Tiempo transcurrido",
        "common.remaining_time_label": "Tiempo estimado restante",
        "common.overall_progress_label": "Progreso general",
        "common.current_operation_label": "Operación actual",
        "common.transferring_label": "Transfiriendo:",
        "common.cancel_ignored_op": "Cancelación ignorada. La operación continúa...",
        "common.cancelled_short": "Cancelado.",
        "common.starting": "Iniciando...",
        "backup.dialog_title_create": "Crear Snapshot",
        "backup.dialog_title_sync": "Sincronizando Snapshot",
        "backup.dialog_title_restore": "Restaurar a {dest}",
        "backup.dialog_title_restore_home": "Restaurando HOME",
        "backup.starting_restore": "Iniciando restauración...",
        "backup.copying_snapshot": "Copiando snapshot...",
        "backup.restore_done_ok": "Restore completado correctamente.",
        "backup.error_prefix": "Error: {msg}",
        "helper.file_not_found": "Archivo no encontrado: {path}",
        "helper.dirs_created": "Directorios creados: {created}",
        "helper.none_placeholder": "ninguno",
        "helper.skipping_no_tool": "Omitiendo {dev}: herramienta '{tool}' no instalada",
        "helper.no_eligible_volume": "No se encontró ningún volumen elegible (todo montado o sin verificador).",
        "helper.no_owner_pkg_found": "No se encontró ningún paquete dueño de estos archivos — no se puede reinstalar automáticamente.",
        "helper.reinstall_done": "Reinstalación completada: {pkgs}",
        "helper.pacman_exit_code": "pacman terminó con código {code} — revise la salida anterior.",
        "helper.invalid_json_args": "Argumentos JSON inválidos: {exc}",
        "helper.unknown_action": "Acción desconocida: {action}",
        "clonezilla.interrupting_compression": "Interrumpiendo compresión...",
        "clonezilla.cancelled_footer": "— Compresión cancelada. —",
        "eggs.cancelling_op": "Cancelando operación...",
        "eggs.cancelled_by_user": "Operación cancelada por el usuario.",
        "eggs.cancelled_footer": "--- Operación cancelada. Directorio /home/eggs eliminado. ---",
        "eggs.done_title": "Completado",
        "eggs.done_success_label": "Completado correctamente",
