...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "clonezilla.raw_hint": "Cópia original do Clonezilla, mantida no disco mesmo após a compressão — pode excluir sem afetar o backup comprimido.",
    ...
    "en": {
        ...
        "clonezilla.raw_hint": "Original Clonezilla copy, kept on disk even after compression — safe to delete without affecting the compressed backup.",
    ...
    "es": {
        ...
        "clonezilla.raw_hint": "Copia original de Clonezilla, conservada en disco incluso tras comprimir — se puede eliminar sin afectar el backup comprimido.",
