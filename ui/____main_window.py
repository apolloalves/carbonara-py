...
class ExitConfirmDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.card.setFixedSize(360, 168)
        ...
        icon_badge.setAlignment(Qt.AlignCenter)
        icon_badge.setStyleSheet(f"background: rgba({_rgba(ACCENT_RED, 18)}); border-radius: 12px;")
        icon_badge.setPixmap(qta.icon("mdi6.power", color=ACCENT_RED).pixmap(20, 20))
